...
class NewOrderWithProspect(TransactionMethod):
    ...
    schema = {Optional('first_name'): condition_for['first_name'],
              ...
              Optional('shipping_address1'): condition_for['shipping_address1'],
              Optional('shipping_address2'): condition_for['shipping_address2'],
              Optional('shipping_city'): condition_for['shipping_city'],
              Optional('shipping_state'): condition_for['shipping_state'],
              Optional('shipping_zip'): condition_for['shipping_zip'],
              Optional('shipping_country'): condition_for['shipping_country'],
              ...
              Optional('email'): condition_for['email'],
              ...
              Optional('ip_address'): condition_for['ip_address'],
              ...
              Required('prospect_id'): condition_for['prospect_id'],
